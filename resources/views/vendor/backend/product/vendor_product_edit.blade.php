    ...
    <div class="card-body p-4">
        ...
        <div class="row">
            ...
            <div class="border border-3 p-4 rounded">
                ...
                <textarea name="short_descrition" class="form-control"  id="inputProductDescription" rows="3">{{$product->short_descrition}}</textarea>
                </div>


                <div class="mb-3">
                <label for="inputProductDescription" class="form-label">Long Description</label>
                <textarea name="long_descrition" class="form-control" id="mytextarea">{!!$product->long_descrition!!}</textarea>
                </div>
...
<!-- start Main Image and thambnails -->
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <img src="{{asset($product->product_thambnail)}}" style="height: 100px; width: 100px;">
            </div>
            <input type="submit" class="btn btn-primary px-4" value="Save Product" />
        </div>
...
<div class="card">
							<div class="card-body">
								<table class="table mb-0 table-striped">
									...
									<tbody>
                    <form  method="POST" action="{{ route('vendor.update.product.multiimag')}}" enctype="multipart/form-data">
                    @csrf
...
<script> 
  ...
  <!-- For get sub category from category -->
