    ...
    <div class="card-body p-4">
        ...
        <div class="row">
            ...
            <div class="border border-3 p-4 rounded">
                ...
                <textarea name="short_descrition" class="form-control"  id="inputProductDescription" rows="3"></textarea>
                </div>


                <div class="mb-3">
                <label for="inputProductDescription" class="form-label">Long Description</label>
                <textarea name="long_descrition" class="form-control" id="mytextarea"></textarea>
                </div>

                <div class="form-group mb-3">
                <label for="inputProductTitle" class="form-label">Thambnail Image</label>
                ...
                <input name="multi_image[]" class="form-control" type="file" id="multiImg" multiple="">
