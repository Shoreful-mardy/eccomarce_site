...
@endphp
                            ...
                            @endphp
                                  ...
                                  @endif
                                    ...
                                    <div class="short-desc mb-30">
                                        <p class="font-lg">{{ $product->short_descrition}}</p>
                                    </div>
      ...
      <button type="submit" id="dqty" class="button button-add-to-cart" onclick="addToCartDetails()"><i class="fi-rs-shopping-cart"></i>Add to cart</button>
...
<div class="single-comment justify-content-between d-flex mb-30">
    <div class="user justify-content-between d-flex">
        <div class="thumb text-center">
            <img src="{{(!empty($item->user->photo)) ? url('upload/users_images/'. $item->user->photo) : url('upload/no_image.jpg') }}" alt="" />
...
<p><b class="text-danger">For Add Product Review . You Need to Login First</b> <a href="{{ route('login')}}">Login Here</a></p>
@else
...
@elseif($avarage == 1 || $avarage < 2)
<div class="rating-result" style="width: 20%"></div>
@elseif($avarage == 2 || $avarage < 3)
<div class="rating-result" style="width: 40%"></div>
@elseif($avarage == 3 || $avarage < 4)
<div class="rating-result" style="width: 60%"></div>
@elseif($avarage == 4 || $avarage < 5)
<div class="rating-result" style="width: 80%"></div>
@elseif($avarage == 5 || $avarage < 5)
<div class="rating-result" style="width:  100%"></div>
@endif
