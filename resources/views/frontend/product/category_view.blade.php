...
@endphp
                    ...
                    @endif
                                ...
                                <span class="font-small ml-5 text-muted">({{count($reviewcount)}}.0)</span>
...
@endforeach
                ...
                <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                 ...
                 @php
                    $product = App\Models\Product::where('category_id',$item->id)->orderBy('id','ASC')->get();
                @endphp
                            <li>
                                <a href="{{ url('product/category/'.$item->id.'/'.$item->category_slug)}}"> <img src="{{ asset($item->category_image)}}" alt="" />{{ $item->category_name}}</a><span class="count">{{ count($product)}}</span>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    @foreach ($newproduct as $item)
                        ...
                        <div class="single-post clearfix">
                            ...
                            <div class="content pt-10">
                                <p><a href="{{ url('product/details/'.$item->id.'/'.$item->product_slug)}}">{{ $item->product_name}}</a></p>
