...
<div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html">
                    	...
                    	@endforeach
                </a> <span></span>{{$blogdetails->post_title}}
                </div>
            </div>
        </div>
        <div class="page-content mb-50">
            ...
            <div class="single-header-meta">
                <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                    ...
                    <span class="post-on has-dot">{{Carbon\Carbon::parse($blogdetails->crated_at)->diffForHumans()}}</span>
 ...
 @foreach($blogcategories as $category)
    	...
    	@endphp
        <li>
            <a href="{{ url('catwise-post/'.$category->id.'/'.$category->blog_category_name)}}"> <img src="{{asset('frontend/assets/imgs/theme/icons/category-1.svg') }}" alt="" />{{$category->blog_category_name}}</a><span class="count">{{count($posts)}}</span>
        </li>
@endforeach
                                        </ul>
                                    </div>
