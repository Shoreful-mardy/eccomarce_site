...
@csrf
            ...
            <div class="row">
                <div class="form-group col-lg-6">
                	<label style="color:black; font-size:15px;">Shiping Name</label>
                    <input type="text" required="" name="shipping_name" value="{{ Auth::user()->name}}">
                </div>
                <div class="form-group col-lg-6">
                	<label style="color:black; font-size:15px;">Shiping Email</label>
                    <input type="email" required="" name="shipping_email" value="{{ Auth::user()->email}}">
                            ...
                            <div class="row shipping_calculator">
                                <div class="form-group col-lg-6">
                                	<label style="color:black; font-size:15px;">Division</label>
                                ...
                                <div class="form-group col-lg-6">
                                	<label style="color:black; font-size:15px;">Phone No</label>
                             ...
                             <div class="row shipping_calculator">
                                <div class="form-group col-lg-6">
                                	<label style="color:black; font-size:15px;">Districts</label>
                                    <div class="custom_select">
                                ...
                                <div class="form-group col-lg-6">
                                	<label style="color:black; font-size:15px;">Post Code </label>
 ...
 <div class="row shipping_calculator">
                                ...
                                <div class="form-group col-lg-6">
                                	<label style="color:black; font-size:15px;"> Address</label>
                            ...
                            <div class="form-group mb-30">
                            	<label style="color:black; font-size:15px;"> Additional Information</label>
...
<!--Get Division to  District Start-->
...
<!--Get Division to  District End-->

<!--Get District to State End-->
<script type="text/javascript">
