                ...
                $.each(response.carts, function(key,value){
                    miniCart += `<ul>
                        <li>
                            ...
                            <div class="shopping-cart-title" style=" margin: -70px 74px 14px; width: 146px;">
...
// Mini Cart Remove End
    ...
    //add to cart in details page start
    ...
    ///end to cart in details page start 
</script>
...
<!--Add to Wishlist End-->
<!--Load Wishlist  Data in view page Start-->
<script type="text/javascript">
...
//<!-- Load Wishlist  Data in view page End-->
...
<!--Load Compare  Data in view page Start-->
<script type="text/javascript">
                    ...
                    <tr class="pr_image">
                                ...
                                <tr class="description">
                                    ...
                                    <td class="row_text font-xs">
                                        <p class="font-sm text-muted">${value.product.short_descrition}</p>
                                    </td>
                                </tr>
                                <tr class="pr_stock">
...
//<!-- Load Compare  Data in view page End-->
            ...
            success:function(response){
                ...
                $.each(response.carts, function(key,value){
                 ...
                 <input type="text" name="quantity" class="qty-val" value="${value.qty}" min="1">
                                    ...
                                    <td class="action text-center" data-title="Remove">
                                    <a  type="submit" id="${value.rowId}" onclick="CartRemove(this.id)" class="text-body"><i class="fi-rs-trash">
                                    </i></a></td>
                                </tr>
                                `
                });
...
<script type="text/javascript">
  ...
  //////////// Start Coupon calculation Method Start////////////  
