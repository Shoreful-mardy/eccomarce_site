...
class VendorProductController extends Controller
{
    ...
    public function VendorAddProduct(){
      ...
      //  $categories = SubCategory::latest()->get();//if you want to sub category in static
    ...
    public function VendorStoreProduct(Request $request){
        ...
        $product_id = Product::insertGetId([
            ...
            'short_descrition' =>$request->short_descrition,
            'long_descrition' =>$request->long_descrition,
        ...
        $images = $request->file('multi_image');
            ...
            $upoloadPath = 'upload/products/multi_image/'.$make_name;

            MultiImg::insert([
                'produt_id' =>$product_id,
                'photo_name' =>$upoloadPath,
                'created_at' =>Carbon::now(),

            ]);
        }//End Foreach

         ///Multiple Image Upload End From Here
    ...
    public function VendorEditProduct($id){
        $multiImgs = MultiImg::where('produt_id',$id)->get();
        $brands = Brand::latest()->get();
        $categories = Category::latest()->get();
 ...
 public function VendorUpdateProductMultiImage(Request $request){
        ...
        if($imgs == NULL){
            $notification = array(
                'message' => 'You Enter Nothing!! Please Enter Image ',
                'alert-type' => 'warning' 
            );
            return redirect()->back()->with($notification);
        }else{
    ...
    public function VendorDeleteProduct($id){
        ...
        $imgs = MultiImg::where('produt_id',$id)->get();
 
        foreach($imgs as $img){
             unlink($img->photo_name);
             MultiImg::where('produt_id',$id)->delete();
        }//End Foreach
